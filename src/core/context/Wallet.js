...
import useAsyncTimeout from '@core/hooks/useAsyncTimeout';
...
export const WalletProvider = ({ children }) => {
    ...
    */
        ...
        try {
            ...
            console.log(
                `Error in localforage.getItem("wallet") in activateNewWallet()`,
            );
            return false;
        }
        // Get savedwallets
        ...
        try {
            ...
            console.log(
                `Error in localforage.getItem("savedWallets") in activateNewWallet()`,
            );
            return false;
        }
        /*
        ...
        */
        ...
        try {
            ...
            console.log(
                `Error in localforage.setItem("savedWallets") in activateNewWallet() for unmigrated wallet`,
            );
        }
        ...
        if (!walletInSavedWallets) {
            ...
            try {
                ...
                console.log(
                    `Error in localforage.setItem("savedWallets") in activateNewWallet()`,
                );
            }
        }
        ...
        if (isLegacyMigrationRequired(walletToActivate)) {
            ...
            try {
                ...
                console.log(
                    `Error in localforage.setItem("wallet", walletToActivate) in activateNewWallet()`,
                );
                return false;
            }
        }
    ...
    const createNewWallet = async importMnemonic => {
        ...
        // console.log("createNewWallet() wallet", wallet);
        ...
        try {
            ...
            console.log(
                `Error setting wallet to wallet indexedDb in createNewWallet()`,
            );
            console.log(err);
        }
        ...
        // } catch (err) {
        //     console.log(
        //         `Error setting wallet to savedWallets indexedDb in createNewWallet()`,
        //     );
        //     console.log(err);
        // }
    ...
    // 		const newWallet = await createNewWallet(testMnemonic);
