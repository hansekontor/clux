...
export const BlockLottoProvider = ({ children }) => {
    ...
    */
    ...
    return (
        <BlockLottoContext.Provider value={{
            ...
            {children}
        </BlockLottoContext.Provider>
    );
};

export const useBlockLotto = () => {
    const context = useContext(BlockLottoContext);
    if (!context) {
        throw new Error("useBlockLotto must be used within a BlockLottoProvider");
    }
    return context;
};